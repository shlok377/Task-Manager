const toggle_cal = document.getElementById("toggle_cal"),
  ...
  close_cal = document.getElementById("close_cal_ID"),
  close_cal_cls = document.getElementById("close_cal");
...
function open_cal_func() {
    cal_container.classList.toggle("open");
    close_cal_cls.classList.toggle("close")
}
function close_cal_func(){
    cal_container.classList.toggle("open")
    close_cal_cls.classList.toggle("close")
}
open_cal.addEventListener("click", open_cal_func);

close_cal.addEventListener("click",close_cal_func);
